...
var arr=[];
arr.push("<div style=\"font-size: 12px;margin:5px 10px;\"><font color=\"#FFFFFF\">简介：给天文的网络电视网站╮(╯▽╰)╭浏览器请使用Firefox或者Google Chrome、、网站所有者：SonJasper，欢迎访问我的博客：http://sonjasper.com/blog<\/div>");
